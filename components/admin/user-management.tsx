...
export function UserManagementSection(props: UserManagementProps) {
    ...
    return (
        <>
                ...
                <CardHeader>
                    ...
                    {selectedIds.size > 0 && (
                        <div className="mt-4 flex flex-wrap gap-2">
                            ...
                            >
                                <span
                                    className="hidden sm:inline">{bulkDeleteLoading ? 'Deleting...' : 'Bulk Delete'}</span>
                            ...
                            <Button variant="ghost" size="sm" onClick={clearSelection}
                                    className="text-xs sm:text-sm">Clear</Button>
                        </div>
                    )}
                </CardHeader>
                <CardContent>
                                        ...
                                        return (
                                            <TableRow key={user.id}>
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center gap-2">
                                                        {user.image ? (
                                                            <img src={user.image || "/wesmun.svg"} alt={user.name}
                                                ...
                                                <TableCell>
                                                    ...
                                                    {isEmergencyAdmin && (
                                                        <p className="text-xs text-orange-600 mt-1">Emergency Admin
                                                            Status
                                                            cannot be revoked</p>
                                                    )}
                                                </TableCell>
            ...
            <Dialog open={bulkEditing} onOpenChange={(open: boolean) => {
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Apply the following changes to {selectedIds.size} selected
            ...
            {/* Bulk Delete Dialog */}
            <Dialog open={bulkDeleteOpen} onOpenChange={(open: boolean) => {
                if (!bulkDeleteLoading) setBulkDeleteOpen(open)
            }}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {bulkDeleteResult ? (
                                ...
                                <>You are about to permanently delete {selectedIds.size} selected
                                    user{selectedIds.size === 1 ? '' : 's'}. This action cannot be undone.</>
                            )}
                        </DialogDescription>
                    </DialogHeader>
                    {bulkDeleteResult ? (
                        ...
                        <div className="space-y-4">
                            <div className="rounded-md border p-3 text-xs text-muted-foreground">
                                <p>Only regular <strong>user</strong> role accounts will be deleted. Admin, security,
                                    overseer, and emergency admin account's are automatically skipped.</p>
                            </div>
                            <div className="flex gap-2 justify-end">
                                <Button
                                    size="sm"
